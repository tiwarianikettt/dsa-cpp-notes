- **CH-02 Conditional Statements & Loops**
    ...
    int main() {
        ...
        n > 0 ? cout << "the number is positive" : cout << "the number is negative or zero";
        return 0;
    }
    ...
    💡NOTE :
        ...
        It is use to stop or break our code in between where we want.
